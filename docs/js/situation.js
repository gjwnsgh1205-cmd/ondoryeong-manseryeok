...
const Situation = (() => {
  ...
  const FIELDS = [
    {
      ...
      q: '지금 가장 마음에 걸리는 일이 무엇인가',
      hint: '길게 쓰지 않아도 되네. 다만 구체적일수록 제대로 짚을 수 있다네.',
    ...
    },
    {
      id: 'want', type: 'pick',
      q: '어떤 답이 필요한가',
      hint: '같은 명식이라도 무엇을 구하느냐에 따라 짚는 자리가 달라진다네.',
      options: [
        ['decide', '결정을 내려야 한다'],
    ...
    {
      id: 'work', type: 'pick', other: '몇 년째인지도 적어주시게',
      q: '요즘 하는 일은',
      options: [
        ['office', '회사에 다닌다'],
        ['own', '내 일을 한다'],
    ...
    },
    {
      ...
      hint: '액수는 묻지 않네. 조언의 무게를 맞추려는 것뿐일세.',
      options: [
        ['ok', '여유가 있다'],
        ['mid', '보통이다'],
        ['tight', '빠듯하다'],
    ...
    },
    {
      ...
      hint: '아픈 데를 묻는 게 아닐세. 자네를 몰아붙이지 않으려고 여쭙네.',
      options: [
        ['fine', '괜찮다'],
        ['tired', '좀 지쳤다'],
        ['worn', '많이 지쳤다'],
  ...
  function validate(values) {
    ...
    if (c.length < 10) return '지금 마음에 걸리는 일을 한두 줄이라도 적어주시게. 그래야 자네 이야기를 얹을 수 있다네.';
    return null;
  }
